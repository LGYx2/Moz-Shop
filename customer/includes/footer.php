            ...
            <div class="col-sm-6 col-md-3"><!--col-sm-6 col-md-3 begin-->
              ...
              <h4>Paginas</h4>
               ...
               <ul><!--ul begin-->
                   ...
                   <li><a href="../contact.php">Conatte-nos</a></li>
                   <li><a href="../shop.php">Loja</a></li>
                   <li><a href="my_account.php?my_orders">Minha Conta</a></li>
               </ul><!--ul end-->
                   ...
                   <li>
                         <?php
                          ...
                          if(!isset($_SESSION['customer_email'])){
                              ...
                              echo"<a href='my_account.php?edit_account'>Editar Conta</a>";
            ...
            <div class="com-sm-6 col-md-3"><!--col-sm-6 col-md-3 begin-->
                ...
                <ul><!--ul begin-->
                    ...
                    <?php
                        ...
                        $raiz_p_cats = mysqli_query($con,$get_p_cats);
                    
                        while($row_p_cats=mysqli_fetch_array($raiz_p_cats)){
